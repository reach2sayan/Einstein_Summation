...
using AT = std::tuple<std::integral_constant<long unsigned int, 0>,
                      std::tuple<std::integral_constant<long unsigned int, 0>,
                      std::tuple<std::integral_constant<long unsigned int, 0>>>>;
using ATF = flatten_tuple_t2<AT>;
...
int main() {
  ...
  using outindex = cartesian_from_labeled_dims_t<holder2::output_labels>;
  using collapsed_index = flatten_tuple_t<cartesian_from_labeled_dims_t<holder2::collapsed_labels>>;
